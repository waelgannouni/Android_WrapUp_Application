...
import com.example.mini_project.LOG_SIGN.RoomImplementaion;
...
public class ProfileFragment extends Fragment {
    ...
    public void InitView(View view){
        ...
        NickName=(TextView) view.findViewById(R.id.Profile_Nickname);
    ...
    public void InitEvent(){
        ...
        NickName.setText("NickName: \b"+nickName);
        FirstName.setText("FirstName: \b"+firstName);
        LastName.setText("LastName: \b"+lastName);
        Email.setText("Email: \b"+email);
    }
}